...
class SaeTOAuthV2 {
	 ...
	 * authorize接口
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/Oauth2/authorize
	 * Oauth2/authorize}
	 *
	 * @param string $url
	 ...
	 * access_token接口
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/OAuth2/access_token
	 * OAuth2/access_token}
	 *
	 * @param string $type
	 ...
	 *
	 * @return array 成功返回array('access_token'=>'value',
	 * 'refresh_token'=>'value'); 失败返回false
	 */
...
class SaeTClientV2 {
	 ...
	 * 获取最新的公共微博消息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/statuses/public_timeline
	 ...
	 *
	 * 获取当前登录用户及其所关注用户的最新微博消息。和用户登录 http://weibo.com
	 * 后在“我的首页”中看到的内容相同。同friends_timeline()
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/statuses/home_timeline
	 ...
	 *
	 * 获取当前登录用户及其所关注用户的最新微博消息。和用户登录 http://weibo.com
	 * 后在“我的首页”中看到的内容相同。同home_timeline()
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/statuses/friends_timeline
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/statuses/user_timeline
	 ...
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/statuses/timeline_batch
	 ...
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/statuses/repost_timeline
	 ...
	 * 获取当前用户最新转发的n条微博消息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/statuses/repost_by_me
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/statuses/mentions
	 * statuses/mentions}
	 *
	 * @access public
	 * @param int $page
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/statuses/show
	 * statuses/show}
	 *
	 * @access public
	 * @param int $id
	 ...
	 * 根据微博id号获取微博的信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/statuses/show_batch
	 * statuses/show_batch}
	 *
	 * @param string $ids
	 ...
	 * 通过微博（评论、私信）ID获取其MID
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/statuses/querymid
	 * statuses/querymid}
	 *
	 * @param int|string $id
	 ...
	 * 通过微博（评论、私信）MID获取其ID
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/statuses/queryid
	 * statuses/queryid}
	 *
	 ...
	 * 按天返回热门微博转发榜的微博列表
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/statuses/hot/repost_daily
	 ...
	 * 按周返回热门微博转发榜的微博列表
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/statuses/hot/repost_weekly
	 ...
	 * 按天返回热门微博评论榜的微博列表
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/statuses/hot/comments_daily
	 ...
	 * 按周返回热门微博评论榜的微博列表
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/statuses/hot/comments_weekly
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/statuses/repost
	 * statuses/repost}
	 *
	 * @access public
	 * @param int $sid
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/statuses/destroy
	 * statuses/destroy}
	 *
	 * @access public
	 * @param int $id
	 ...
	 * <br
	 * />注意：为防止重复提交，当用户发布的微博消息与上次成功发布的微博消息内容一样时，将返回400错误，给出错误提示：“40025:Error:
	 * repeated weibo text!“。
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/statuses/update
	 * statuses/update}
	 *
	 * @access public
	 * @param string $status
	 ...
	 * 可选参数。元数据，主要是为了方便第三方应用记录一些适合于自己使用的信息。每条微博可以包含一个或者多个元数据。请以json字串的形式提交，字串长度不超过512个字符，或者数组方式，要求json_encode后字串长度不超过512个字符。具体内容可以自定。例如：'[{"type2":123},
	 * {"a":"b", "c":"d"}]'或array(array("type2"=>123),
	 * array("a"=>"b", "c"=>"d"))。
	 * @return array
	 */
	 ...
	 * <br
	 * />注意：lat和long参数需配合使用，用于标记发表微博消息时所在的地理位置，只有用户设置中geo_enabled=true时候地理位置信息才有效。
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/statuses/upload
	 * statuses/upload}
	 *
	 * @access public
	 * @param string $status
	 ...
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/statuses/upload_url_text
	 ...
	 *
	 * 返回最新n条发送及收到的评论。
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/comments/timeline
	 * comments/timeline}
	 *
	 * @access public
	 * @param int $page
	 ...
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/comments/mentions
	 * comments/mentions}
	 *
	 * @param int $since_id
	 * 若指定此参数，则返回ID比since_id大的评论（即比since_id时间晚的评论），默认为0。
	 ...
	 * 根据评论ID批量返回评论信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/comments/show_batch
	 * comments/show_batch}
	 *
	 * @param string $cids
	 ...
	 * 对一条微博进行评论
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/comments/create
	 * comments/create}
	 *
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/statuses/comment_destroy
	 ...
	 *
	 * 注意：只能删除自己发布的评论，发部微博的用户不可以删除其他人的评论。
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/comments/destroy_batch
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/comments/reply
	 * comments/reply}
	 *
	 * @access public
	 * @param int $sid
	 ...
	 * 批量获取用户信息按uids
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/users/show_batch
	 * users/show_batch}
	 *
	 * @param string $uids
	 * 需要查询的用户ID，用半角逗号分隔，一次最多20个。
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/friendships/friends
	 * friendships/friends}
	 *
	 * @access public
	 * @param int $cursor
	 ...
	 * 获取两个用户之间的共同关注人列表
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/friendships/friends/in_common
	 ...
	 * 获取用户的双向关注列表，即互粉列表
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/friendships/friends/bilateral
	 ...
	 *
	 * 如果没有提供cursor参数，将只返回最前面的5000个关注id
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/friendships/friends/ids
	 ...
	 *
	 * 对应API：{@link
	 * http://open.weibo.com/wiki/2/friendships/friends/remark_batch
	 ...
	 * 获取用户的粉丝列表
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/friendships/followers
	 ...
	 * 获取优质粉丝
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/friendships/followers/active
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/friendships/show
	 * friendships/show}
	 *
	 * @access public
	 ...
	 * 关注一个用户。
	 *
	 * 成功则返回关注人的资料，目前最多关注2000人，失败则返回一条字符串的说明。如果已经关注了此人，则返回http
	 * 403的状态。关注不存在的ID将返回400。
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/friendships/create
	 * friendships/create}
	 *
	 * @access public
	 * @param int $uid
	 ...
	 * 关注一个用户。
	 *
	 * 成功则返回关注人的资料，目前的最多关注2000人，失败则返回一条字符串的说明。如果已经关注了此人，则返回http
	 * 403的状态。关注不存在的ID将返回400。
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/friendships/create
	 * friendships/create}
	 *
	 ...
	 * 根据用户UID批量关注用户
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/friendships/create_batch
	 * friendships/create_batch}
	 *
	 * @param string $uids
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/friendships/destroy
	 * friendships/destroy}
	 *
	 * @access public
	 * @param int $uid
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/friendships/remark/update
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/direct_messages
	 * direct_messages}
	 *
	 * @access public
	 * @param int $page
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/direct_messages/sent
	 ...
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/direct_messages/user_list
	 * direct_messages/user_list}
	 *
	 * @param int $count
	 * 单页返回的记录条数，默认为20。
	 * @param int $cursor
	 ...
	 * 获取与指定用户的往来私信列表
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/direct_messages/conversation
	 ...
	 * 根据私信ID批量获取私信内容
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/direct_messages/show_batch
	 * direct_messages/show_batch}
	 *
	 * @param string $dmids
	 ...
	 *
	 * 发送一条私信。成功将返回完整的发送消息。
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/direct_messages/new
	 * direct_messages/new}
	 *
	 * @access public
	 * @param int $uid
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/direct_messages/destroy
	 ...
	 * @access public
	 * @param mixed $dids
	 * 欲删除的一组私信ID，用半角逗号隔开，或者由一组评论ID组成的数组。最多20个。例如："4976494627,
	 ...
	 * 获取用户基本信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/profile/basic
	 ...
	 * 获取用户的教育信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/profile/education
	 * account/profile/education}
	 *
	 * @param int $uid
	 ...
	 * 批量获取用户的教育信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/profile/education_batch
	 * account/profile/education_batch}
	 *
	 * @param string $uids
	 ...
	 * 获取用户的职业信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/profile/career
	 * account/profile/career}
	 *
	 * @param int $uid
	 * 需要获取教育信息的用户UID，默认为当前登录用户。
	 * @return array
	 ...
	 * 批量获取用户的职业信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/profile/career_batch
	 * account/profile/career_batch}
	 *
	 * @param string $uids
	 * 需要获取教育信息的用户UID，用半角逗号分隔，最多不超过20。
	 * @return array
	 ...
	 * 获取隐私信息设置情况
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/get_privacy
	 * account/get_privacy}
	 *
	 * @access public
	 * @return array
	 ...
	 * 获取所有的学校列表
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/profile/school_list
	 * account/profile/school_list}
	 *
	 * @param array $query
	 * 搜索选项。格式：array('key0'=>'value0', 'key1'=>'value1',
	 * ....)。支持的key:
	 ...
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/rate_limit_status
	 ...
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/get_uid
	 * account/get_uid}
	 *
	 * @access public
	 * @return array
	 ...
	 * 更改用户资料
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/profile/basic_update
	 * account/profile/basic_update}
	 *
	 * @access public
	 * @param array $profile
	 ...
	 * 设置教育信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/profile/edu_update
	 * account/profile/edu_update}
	 *
	 * @access public
	 ...
	 * 根据学校ID删除用户的教育信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/profile/edu_destroy
	 * account/profile/edu_destroy}
	 *
	 * @param int $id
	 * 教育信息里的学校ID。
	 * @return array
	 ...
	 * 设置职业信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/profile/car_update
	 * account/profile/car_update}
	 *
	 ...
	 * 根据公司ID删除用户的职业信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/profile/car_destroy
	 * account/profile/car_destroy}
	 *
	 * @access public
	 * @param int $id
	 * 职业信息里的公司ID
	 ...
	 * 更改头像
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/avatar/upload
	 * account/avatar/upload}
	 *
	 * @param string $image_path
	 * 要上传的头像路径, 支持url。[只支持png/jpg/gif三种格式, 增加格式请修改get_image_mime方法]
	 * 必须为小于700K的有效的GIF, JPG图片. 如果图片大于500像素将按比例缩放。
	 * @return array
	 */
	 ...
	 * 设置隐私信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/account/update_privacy
	 ...
	 *
	 * 根据收藏ID获取指定的收藏信息。
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/favorites/show
	 * favorites/show}
	 *
	 * @access public
	 * @param int $id
	 ...
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/favorites/by_tags
	 * favorites/by_tags}
	 *
	 *
	 * @param int $tid
	 ...
	 * 收藏一条微博信息
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/favorites/create
	 * favorites/create}
	 *
	 * @access public
	 * @param int $sid
	 ...
	 * 删除微博收藏。
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/favorites/destroy
	 * favorites/destroy}
	 *
	 * @access public
	 * @param int $id
	 ...
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/favorites/destroy_batch
	 ...
	 * 更新一条收藏的收藏标签
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/favorites/tags/update
	 ...
	 * 更新当前登录用户所有收藏下的指定标签
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/favorites/tags/update_batch
	 ...
	 * 判断当前用户是否关注某话题
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/trends/is_follow
	 * trends/is_follow}
	 *
	 * @access public
	 ...
	 * 批量获取用户的标签列表
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/tags/tags_batch
	 * tags/tags_batch}
	 *
	 * @param string $uids
	 ...
	 * 返回用户感兴趣的标签
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/tags/suggestions
	 * tags/suggestions}
	 *
	 * @access public
	 * @param int $count
	 ...
	 * @access public
	 * @param mixed $tags
	 * 要创建的一组标签，每个标签的长度不可超过7个汉字，14个半角字符。多个标签之间用逗号间隔，或由多个标签构成的数组。如："abc,drf,efgh,tt"或array("abc",
	 * "drf", "efgh", "tt")
	 * @return array
	 */
	 ...
	 * 批量删除标签
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/tags/destroy_batch
	 * tags/destroy_batch}
	 *
	 * @access public
	 * @param mixed $ids
	 * 必选参数，要删除的tag id，多个id用半角逗号分割，最多10个。或由多个tag
	 * id构成的数组。如：“553,554,555"或array(553, 554, 555)
	 * @return array
	 */
	 ...
	 * 验证昵称是否可用，并给予建议昵称
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/register/verify_nickname
	 ...
	 * 搜索用户时的联想搜索建议
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/search/suggestions/users
	 ...
	 * 搜索微博时的联想搜索建议
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/search/suggestions/statuses
	 ...
	 * 搜索学校时的联想搜索建议
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/search/suggestions/schools
	 ...
	 * 搜索公司时的联想搜索建议
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/search/suggestions/companies
	 ...
	 * ＠用户时的联想建议
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/search/suggestions/at_users
	 ...
	 * 搜索与指定的一个或多个条件相匹配的微博
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/search/statuses
	 * search/statuses}
	 *
	 * @param array $query
	 * 搜索选项。格式：array('key0'=>'value0', 'key1'=>'value1',
	 ...
	 *
	 * 返回系统推荐的用户列表。
	 * <br />对应API：{@link http://open.weibo.com/wiki/2/suggestions/users/hot
	 ...
	 *
	 * 对应API：{@link
	 * http://open.weibo.com/wiki/2/suggestions/users/may_interested
	 ...
	 * 根据一段微博正文推荐相关微博用户。
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/suggestions/users/by_status
	 ...
	 * 热门收藏
	 *
	 * 对应API：{@link http://open.weibo.com/wiki/2/suggestions/favorites/hot
	 ...
	 *
	 * 对应API：{@link
	 * http://open.weibo.com/wiki/2/suggestions/users/not_interested
...
class MyManage {
	...
	function getUserInfo($c, $uid_get) {
		// 获取用户信息
		$uid = $uid_get ['uid'];
		$rs = $c->show_user_by_id ( $uid ); // 通过上面的例子可以知道得到的rs也是数组
		echo $rs ['screen_name'] . '<br/>';
	}
	function getWeibos(SaeTClientV2 $c, $uid, $page) {
		printf ( '%s', '<br>me!' );
		$weibos_get = $c->user_timeline_by_id ( $uid, $page, WB_WEIBO_PAGE_SIZE ); // 获取第一页
		// 每页10个
		echo $weibos_get ['total_number'] . '<br/>'; // 930个weibo 输出931！！！
		$status_get = $weibos_get ['statuses'];
		foreach ( $status_get as $weibo ) {
			echo $weibo ['text'] . "---" . $weibo ['created_at'] . '<br/>';
		}
	}
	function getFriends(SaeTClientV2 $c, $uid, $cursor) {
		// 这里和微博不同 用的是cursor page是从1开始的
		// cursor是从0开始的
		$friends_get = $c->friends_by_id ( $uid, $cursor, WB_USER_PAGE_SIZE );
		echo '<br/> total ' . $friends_get ['total_number'] . '<br/>';
		$users_get = $friends_get ['users'];
		
		$count = count ( $users_get );
		printf ( '%d', $count );
...
class MyUtils {
	...
	function getTime($str) {
		...
		$b2 = strpos ( $str, ' ', $b1 + 1 );
		$month_str = substr ( $str, $b1 + 1, $b2 - $b1 - 1 );
		$month = - 1;
		switch ($month_str) {
			case 'Jan' :
				$month = 1;
		...
		// 第二个空格和第三个空格 为了取出日期
		$b3 = strpos ( $str, ' ', $b2 + 1 );
		$date_str = substr ( $str, $b2 + 1, $b3 - $b2 );
		$params ['date'] = ($date_str);
		
		// 第三个和第四个空格 为了取出时间
		$b4 = strpos ( $str, ' ', $b3 + 1 );
		$time_str = substr ( $str, $b3 + 1, $b4 - $b3 );
		$params ['time'] = $time_str;
		
		$year_str = substr ( $str, strlen ( $str ) - 4, 4 );
			...
			} else //其他情况下，包括小写字母和半角标点符号，
{
	...
	function textSummary($text) {
		//if ($this->sstrlen ( $text,'utf-8' ) > 70) {
		if ($this->strLength ( $text ) > 70) {
			$text = $this->cut_str ( $text, 70 );
		}
		return $text;
	}
